...
exports.registerWorkbookCommands = void 0;
const fs = __importStar(require("fs-extra"));
const path = __importStar(require("path"));
const axios_1 = __importDefault(require("axios"));
const exceljs_1 = __importDefault(require("exceljs"));
// In-memory storage for user workbook states
const userWorkbookStates = new Map();
const registerWorkbookCommands = (bot, deps) => {
    ...
    const initUserWorkbookState = (userId) => {
        const state = {
            newFolderPath: "",
            imageCounter: 1,
            videoCounter: 1,
    ...
    const getUserWorkbookState = (userId) => {
    ...
    bot.onText(/\/workbook/, (msg) => {
        ...
        bot.sendMessage(msg.chat.id, 'Anda sekarang dalam mode Workbook. Perintah yang tersedia:\n' +
    ...
    bot.on('message', async (msg) => {
        ...
        try {
            ...
            if (msg.text && msg.text.toLowerCase() === 'cek') {
                ...
                bot.sendMessage(chatId, `Berikut adalah daftar sheet yang telah dibuat:\n${folderList}\nTotal Ukuran: ${totalSizeInMegabytes.toFixed(2)} MB`);
                return;
            }
            ...
            if (msg.text && msg.text !== "clear" && msg.text !== "send" && msg.text !== "cek") {
                ...
                state.downloadCount = 0;
                bot.sendMessage(chatId, `Sheet dengan nama ${newFolderName} telah dibuat. Anda sekarang bisa mengirim foto.`);
                return;
            }
...
exports.registerWorkbookCommands = registerWorkbookCommands;
